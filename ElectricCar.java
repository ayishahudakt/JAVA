...
public class ElectricCar extends Car {
    ...
    public ElectricCar(String reg_no, int speed, int cap, int numberOfDoors,
                       Boolean hasAirConditioning, int battery, int charge) {
    ...
    public static void main(String[] args) {
        ...
        System.out.print("Enter the number of ElectricCars you want to add: ");
        int n = sc.nextInt();
        ...
        for (int i = 0; i < n; i++) {
            ...
            electricCars[i] = new ElectricCar(regNo, speed, fuelCapacity, numberOfDoors,
                    hasAirConditioning, batteryCapacity, chargeLevel);
        }
